# pip install -U langchain langchain-groq langchain-huggingface langchain-community faiss-cpu pypdf python-dotenv langsmith
...
PDF_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "islr.pdf")
